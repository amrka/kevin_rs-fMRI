...
export_fig("/Users/aeed/Documents/Kevin/functional_conn_figures/" + run + "/dim_" + n_dims + "/" + run + "_dim_" + n_dims + "_spectrum_before_cleaning", "-m2")
...
export_fig("/Users/aeed/Documents/Kevin/functional_conn_figures/" + run + "/dim_" + n_dims + "/" + run + "_dim_" + n_dims + "_comps", "-m2")
ts_spectra=nets_spectra(ts);             % have a look at mean spectra after this cleanup
export_fig("/Users/aeed/Documents/Kevin/functional_conn_figures/" + run + "/dim_" + n_dims + "/" + run + "_dim_" + n_dims + "_spectrum_after_cleaning", "-m2")
...
export_fig("/Users/aeed/Documents/Kevin/functional_conn_figures/" + run + "/dim_" + n_dims + "/" + run + "_dim_" + n_dims + "_z-stats_one_gp_t-test_full_corrleation", "-m2")
...
export_fig("/Users/aeed/Documents/Kevin/functional_conn_figures/" + run + "/dim_" + n_dims + "/" + run + "_dim_" + n_dims + "_z-stats_one_gp_t-test_partial_corrleation", "-m2")
...
export_fig("/Users/aeed/Documents/Kevin/functional_conn_figures/" + run + "/dim_" + n_dims + "/" + run + "_dim_" + n_dims + "_z-stats_one_gp_t-test_reg_partial_corrleation", "-m2")
...
export_fig("/Users/aeed/Documents/Kevin/functional_conn_figures/" + run + "/dim_" + n_dims + "/" + run + "_dim_" + n_dims + "_hierarchy_full_correlation", "-m2")
...
export_fig("/Users/aeed/Documents/Kevin/functional_conn_figures/" + run + "/dim_" + n_dims + "/" + run + "_dim_" + n_dims + "_hierarchy_partial_correlation", "-m2")
...
export_fig("/Users/aeed/Documents/Kevin/functional_conn_figures/" + run + "/dim_" + n_dims + "/" + run + "_dim_" + n_dims + "_hierarchy_reg_partial_correlation", "-m2")
...
export_fig("/Users/aeed/Documents/Kevin/functional_conn_figures/" + run + "/dim_" + n_dims + "/" + run + "_dim_" + n_dims + "_Pvalue_two-group_t-test_full_correlation", "-m2")

[p_uncorrected_P,p_corrected_P]=nets_glm(netmats_P, design, contrast,1);
export_fig("/Users/aeed/Documents/Kevin/functional_conn_figures/" + run + "/dim_" + n_dims + "/" + run + "_dim_" + n_dims + "_Pvalue_two-group_t-test_partial_correlation", "-m2")

[p_uncorrected_rP,p_corrected_rP]=nets_glm(netmats_rP, design, contrast,1);
export_fig("/Users/aeed/Documents/Kevin/functional_conn_figures/" + run + "/dim_" + n_dims + "/" + run + "_dim_" + n_dims + "_Pvalue_two-group_t-test_reg_partial_correlation", "-m2")
...
export_fig("/Users/aeed/Documents/Kevin/functional_conn_figures/" + run + "/dim_" + n_dims + "/" + run + "_dim_" + n_dims + "_most_sig_full_correlation_gp1>gp2", "-m2")

nets_edgepics(ts,group_maps,Znet_P,reshape(p_corrected_P(1,:),ts.Nnodes,ts.Nnodes),6);
export_fig("/Users/aeed/Documents/Kevin/functional_conn_figures/" + run + "/dim_" + n_dims + "/" + run + "_dim_" + n_dims + "_most_sig_partial_correlation_gp1>gp2", "-m2")

nets_edgepics(ts,group_maps,Znet_rP,reshape(p_corrected_rP(1,:),ts.Nnodes,ts.Nnodes),6);
export_fig("/Users/aeed/Documents/Kevin/functional_conn_figures/" + run + "/dim_" + n_dims + "/" + run + "_dim_" + n_dims + "_most_sig_reg_partial_correlation_gp1>gp2", "-m2")
