...
# 10
for img in `ls ${1}/Kevin/subtraction/_dim_10/subtraction_dim_*_dr_stage2_ic*.nii.gz`;do
...
# =============================================15=============================================
# 15
for img in `ls ${1}/Kevin/subtraction/_dim_15/subtraction_dim_*_dr_stage2_ic*.nii.gz`;do
...
# =============================================20=============================================
# 20
for img in `ls ${1}/Kevin/subtraction/_dim_20/subtraction_dim_*_dr_stage2_ic*.nii.gz`;do
...
# =============================================25=============================================
# 25
for img in `ls ${1}/Kevin/subtraction/_dim_25/subtraction_dim_*_dr_stage2_ic*.nii.gz`;do
...
# =============================================40=============================================
# 40
for img in `ls ${1}/Kevin/subtraction/_dim_40/subtraction_dim_*_dr_stage2_ic*.nii.gz`;do
...
# =============================================50=============================================
# 50
for img in `ls ${1}/Kevin/subtraction/_dim_50/subtraction_dim_*_dr_stage2_ic*.nii.gz`;do
...
# =============================================100=============================================
# 100
for img in `ls ${1}/Kevin/subtraction/_dim_100/subtraction_dim_*_dr_stage2_ic*.nii.gz`;do
